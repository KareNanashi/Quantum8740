...
public class AlignAndMoveToApriltag extends Command {
  /** Creates a new AlignAndMoveToApriltag. */
  ...
  public AlignAndMoveToApriltag(Vision vision, Chasis chasis) {
  ...
  public void execute() {
    //Alinear 
    double yawError = Math.abs(vision.getZAngle());
