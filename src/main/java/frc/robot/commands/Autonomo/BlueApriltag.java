...
public class BlueApriltag extends Command {
  /** Creates a new BlueApriltag. */
  ...
  public BlueApriltag(Chasis chasis, Vision vision) {
  ...
  @Override
  public void execute() {
    if (vision.getIDApriltag() == id_13 || vision.getIDApriltag() == id_19){
