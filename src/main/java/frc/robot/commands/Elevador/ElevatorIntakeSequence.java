...
public class ElevatorIntakeSequence extends SequentialCommandGroup {
  /** Creates a new ElevatorIntakeSequence. */
  // double elevatorTarget = 50; // Valor de ejemplo para la posición del elevador
  // double intakeTarget = 100;  // Valor de ejemplo para el ángulo del intake
