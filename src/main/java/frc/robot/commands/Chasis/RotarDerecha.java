...
public class RotarDerecha extends Command {
  /** Creates a new RotarDerecha. */
  private final Chasis chasis;
  private final double right_speed;
  private final double left_speed;
  private final double degree;
  public RotarDerecha(Chasis chasis, double right_speed, double left_speed, double degree) {
  ...
  return currentDistance >= targetDistance;
    //return chasis.rot(chasis.rotacion(degree), chasis.get_left_encoder_distance());
  }
}
